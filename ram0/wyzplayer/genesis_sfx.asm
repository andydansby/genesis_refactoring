...
;TABLA_EFECTOS		defw TABLA DE DIRECCIONES DE LOS EFECTOS
;INTERR			defb
...
PUNTERO_EFECTO:
		defw	0   ;defw : PUNTERO DEL SONIDO QUE SE REPRODUCE;REPRODUCE EFECTOS
		
PUBLIC _CANAL_EFECTOS		
_CANAL_EFECTOS:
...
_REPRODUCE_EFECTO:
		...
		LD      A,10111000B		;	ELIMINA RUIDO
       		LD      (PSG_REG_SEC+7),A
                ...
                LD      (PUNTERO_EFECTO),HL
           	LD	IX,PSG_REG_SEC
                LD	A,(_CANAL_EFECTOS)	;SELECCION DE CANAL *********
                CP	1
                JR	Z,RS_CANALA
                CP	2
		JR	Z,RS_CANALB
