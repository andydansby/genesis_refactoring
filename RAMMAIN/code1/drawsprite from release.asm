...
;;Multiply_by_96
;;dw 0,96,192,288,384,480,576,672,768,864,960,1056,1152,1248,1344,1440,1536,1632,1728,1824,1920,2016,2112,2208,2304,2400,2496,2592,2688,2784,2880,2976,3072,3168,3264,3360,3456,3552,3648,3744,3840,3936

Multiply_by_48
;#BEGIN_ASM
dw 0, 48, 96, 144, 192, 240, 288, 336, 384, 432, 480, 528, 576, 624, 672, 720, 768, 816, 864, 912, 960, 1008, 1056, 1104, 1152, 1200, 1248, 1296
...
;;	2- Use also for collision checks, update variable 
;;	collision with the result
;; Input:
;;	DE: sprite number
;;	B: X position
;;	C: Y position
