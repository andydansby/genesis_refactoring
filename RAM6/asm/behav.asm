...
;	DE: speed_y   ( D: integer part, E fractional part). Bit 0 of D defines sign (0: positive, 1: negative)
	...
	dx_greater_dy:
		...
		ld e, c
		push bc
		call _Div8		; speed_y = abs(dy) / abs (dx), sign is stored elsewhere
		pop bc
		rl d
		rla
		rl d
	...
	dy_greater_dx:
		...
		ld e, b
		push bc
		call _Div8		; speed_x = abs(dx) / abs (dy), sign is stored elsewhere
		pop bc
		rl d
		rla
		rl d
