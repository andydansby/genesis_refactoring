...
screen_to_show:
	defb 0
	;; 0: title screen; 1: hi scores; 2: credits
...
no_cheat_pressed:
	...
	and a
	ret z	
	;; key was already released, and carry flag is now 0
	xor a	; clear carry		
	ld (key_i_pressed), a
ret
;#END_ASM
...
;;title_hiscores INCBIN "title_hiscores.bin"//placed in ram6.asm
;;credits_bkg INCBIN "credits_bkg.bin"//placed in ram6.asm


;;makes no sense in Z88dk
;;ATTENTION
;;org 57343
;;defb 0
