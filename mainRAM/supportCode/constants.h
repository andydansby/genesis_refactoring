...
unsigned int level_address[]=
{
	0xC000,0xC65E,0xCD82,0xD31C,0xDADC,0xE3A3,0xEC43
};	// Level addresses

unsigned int enemy_address[]=
{0xC31D,0xCB29,0xCF7B,0xD7A3,0xDFEA,0xE8A2,0xF04B
};        // Enemy addresses

unsigned int finalenemy_address[]=
{
	0xF3CC,0xF3ED,0xF426,0xF447,0xF478,0xF499,0xF4BA
};  // Addresses of final enemy definitions




// Enemy and specific sprites for each level
unsigned int levelsprites[]=
{69,22,100,22,131,129,203};

// Final enemy sprites
unsigned int finalspr[]=
{76,93,113,64,159,175,216};

// Final enemy sprite count
unsigned int finalspr_count[]=
{17,7,16,5,16,18,16};

// Colors for each level
unsigned char levelcolors[]=
{5,6,7,0x44,0x46,0x45,5};

// Level checkpoints (up to 4 per level, first is the beginning)
unsigned char level_checkpoints[]=
{
	0, 60, 120, 180,	// Level 1
	0, 40, 84, 145,		// Level 2
	0, 40, 83, 135,		// Level 3
	0, 30, 78, 126,		// Level 4
...
unsigned char finalenemy_sprites[]=
{
	FINALE_SPR1,FINALE_SPR2,FINALE_SPR3,FINALE_SPR4,FINALE_SPR5,FINALE_SPR6,FINALE_SPR7
};

// Shoot sprites
unsigned char shoot_sprites[]=
{
	SHOT_BASIC,SHOT_BASIC,SHOT_LASER,SHOT_HOMING,SHOT_BOMB,SHOT_MEGA
};


unsigned char shoot_energy[]=
{1,1,3,3,2,4};

unsigned char shoot_max_number[]=
{2,4,2,2,4,8};
...
unsigned char level_music[]=
{4,5,6,7,8,9,10};

unsigned char finalenemy_music[]=
...
unsigned char fxchannel_music[]=
{1,1,1,1,1,2,1,1,1,3,1,1,1,1,1};
