...
;; Routine to paint the map ... may God catch me confused

;; Entry:
; 	DE: Map + scrolling the map in tiles
; 	BC: map scrolling; B: chars (0-2), C: pixels (0,1,2,3)
; 	HL: map width in characters
;	TablaTiles: table with tiles already preshifted (ver create_shifted_tiles.asm), en $B000
...
; IMPORTANT: ENTER WITH DISABLED INTERRUPTIONS!!!!!!!
	...
	push de
	call _ClearMapArea		; limpia la pantalla
...
PUBLIC _ClearMapArea
	_ClearMapArea:
;#BEGIN_ASM
	;; This little function will clear the map area 
	;;on screen, via a series of PUSH
