...
;#BEGIN_ASM
	...
	xor a
	ld (_Ship_Collision), a			; 0 == no collision
...
LRU_first:
	defb 0
LRU_last:
	defb 84			; pointers to the first and last entry in the cache
